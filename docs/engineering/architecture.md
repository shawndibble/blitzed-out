...
| i18n               | i18next + `react-i18next`, lazy-loaded resources, 6 locales. `services/locale.ts` is the single read/write seam — see CLAUDE.md's i18n note before adding a language |
